...
public class TravelBuddyDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TravelBuddyDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TravelBuddyResource>("es")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/TravelBuddy");

            options.DefaultResourceType = typeof(TravelBuddyResource);
        ...
        {
            options.MapCodeNamespace("TravelBuddy", typeof(TravelBuddyResource));
        });
    }
}
